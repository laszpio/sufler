...
describe Sufler::Cue do
  ...
  let(:multi_lines_cue) do
    Sufler::Cue.new(
      ...
      ends: '00:01.000',
      lines: [
        'First second text part 1',
        'First second text part 2'
      ]
    )
  end
  ...
  describe '#lines' do
    context 'single text line' do
      ...
      it { expect(subject).to include 'First second text line' }
    end
    ...
    context 'multiple text lines' do
      ...
      it { is_expected.to include 'First second text part 1' }

      it { is_expected.to include 'First second text part 2' }
    end
  end
  ...
  describe '#to_s' do
    context 'single lines cue' do
      ...
      it 'starts with formated times' do
        expect(subject.lines.first)
          . to start_with "#{cue.starts} --> #{cue.ends}"
      end
    ...
    context 'multi lines cue' do
      ...
      it "contains formatted cue's text for every line" do
        is_expected.to match '- First second text part 1\n'
        is_expected.to match '- First second text part 2\n'
      end
    end
  end
end
